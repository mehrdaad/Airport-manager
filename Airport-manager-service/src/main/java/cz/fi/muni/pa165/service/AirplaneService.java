...
public interface AirplaneService {
    ...
    /**
     * Find all airplanes in the given time range
     *
     * @param start the date since when to find airplanes
     * @param end   the date until when find airplanes
     * @return All airplanes that are free in the given time range
     */
    List<Airplane> findFreeAirplanesInTimeRange(LocalDateTime start, LocalDateTime end);
}
